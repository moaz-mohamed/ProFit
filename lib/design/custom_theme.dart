...
abstract class CustomTheme {
  static Color get mainColorSimple => const Color(0xFF51D684);
  ...
  static Color get backgroundColor => const Color.fromRGBO(244, 244, 244, 1);
  static Color get lightScaffoldBackgroundColor => const Color(0xFFFAFAFA);
  ...
  static get authInputDecoration => InputDecoration(
    ...
    contentPadding: const EdgeInsets.only(bottom: 0.0, left: 5.0, right: 5.0),
  );
  ...
  static EdgeInsets get pagePadding => const EdgeInsets.only(top: 40.0);
}
